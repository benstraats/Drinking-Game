...
class Utils {
    ...
    static String[] tasks = {
            ...
            PLAYER_SEPERATOR + " hand out 1 drink.",
            ...
            PLAYER_SEPERATOR + " must put someone elses finger in their mouth or finish their drink",
            ...
            PLAYER_SEPERATOR + " and " + PLAYER_SEPERATOR + " have to rock, paper, scissors. Loser drink 3 times.",
            "Types of flowers, loser drinks 2 times. " + PLAYER_SEPERATOR + " starts.",
            "Movies in the marvel universe, loser drinks 4 times. " + PLAYER_SEPERATOR + " starts.",
            "Person who lives the farthest give out 4 drinks.",
            PLAYER_SEPERATOR + " pour some of your drink into the communal cup.",
            PLAYER_SEPERATOR + " pour some of your drink into the communal cup.",
            PLAYER_SEPERATOR + " pour some of your drink into the communal cup.",
            PLAYER_SEPERATOR + " pour some of your drink into the communal cup.",
            PLAYER_SEPERATOR + " pour some of your drink into the communal cup.",
            PLAYER_SEPERATOR + " pour some of your drink into the communal cup.",
            PLAYER_SEPERATOR + " drink the communal cup.",
            PLAYER_SEPERATOR + " flip a coin and call the result. If you're correct give out 3 drinks, if you're wrong drink 3 times.",
            "Name Jedis or Siths. " + PLAYER_SEPERATOR + " goes first. Loser drinks 3 times.",
            PLAYER_SEPERATOR + " has to stroke their wizard beard constantly for the next 5 tasks.",
            //TODO: FIX UP ALL THESE BELOW THIS LINE
            "Everyone vote at the same time. Best star wars movie. Winning group hands out 5 drinks as a team.",
            "Everyone vote at the same time. Best Lord of the Rings character. Winning group hands out 5 drinks as a team.",
            "Everyone vote at the same time. Best president of the US. Winning group hands out 5 drinks as a team.",
            "Everyone vote at the same time. Best car company. Winning group hands out 5 drinks as a team.",
            "Everyone vote at the same time. Best Harry Potter movie. Winning group hands out 5 drinks as a team.",
            "Everyone vote at the same time. Best . Winning group hands out 5 drinks as a team.",
            "Everyone vote at the same time. Worst spiderman actor. Losers drink 3 times.",
            "Everyone vote at the same time. Worst . Winning group hands out 5 drinks as a team.",
            "Everyone vote at the same time. Worst . Winning group hands out 5 drinks as a team.",
            "Everyone vote at the same time. Worst . Winning group hands out 5 drinks as a team.",
            "Everyone vote at the same time. Worst . Winning group hands out 5 drinks as a team.",
            "Everyone vote at the same time. Worst . Winning group hands out 5 drinks as a team.",
            "Everyone vote at the same time. Worst . Winning group hands out 5 drinks as a team.",
            "Everyone vote at the same time. Justin Bieber or Miley Cyrus. Winning group hands out 5 drinks as a team.",
            "Everyone vote at the same time. Beer or wine. Winning group hands out 5 drinks as a team.",
            "Everyone vote at the same time. Summer or winter. Winning group hands out 5 drinks as a team.",
            "Everyone vote at the same time. Money of fame. Winning group hands out 5 drinks as a team.",
            PLAYER_SEPERATOR + " and " + PLAYER_SEPERATOR + " have to swap seats or drink 5 times each.",
    };
}
